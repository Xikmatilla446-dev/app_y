    ...
    const links = [
        ...
        },
        {
            ...
            submenu: [
                ...
                {
                    title: t("Jamoatchilik kengashining ochiqlikni ta’minlash, korrupsiyaga qarshi kurashish va davlat organi faoliyatini takomillashtirish"),
                    href: "/",
                },
                {
        ...
        <div className={classes.main_navbar}>
            <Container>
                <div className={classNames(classes.navbar,  open ? classes.open : "")}>
                    ...
                    <div className={classes.menu_icon}><div onClick={toggle} /></div>
